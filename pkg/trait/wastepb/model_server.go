...
func (m *ModelServer) Register(server *grpc.Server) {
	traits.RegisterWasteApiServer(server, m)
}
...
func (m *ModelServer) ListWasteRecords(ctx context.Context, req *traits.ListWasteRecordsRequest) (*traits.ListWasteRecordsResponse, error) {
	...
	resp := &traits.ListWasteRecordsResponse{}
...
func (m *ModelServer) PullWasteRecords(request *traits.PullWasteRecordsRequest, server traits.WasteApi_PullWasteRecordsServer) error {
